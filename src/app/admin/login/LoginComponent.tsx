      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-gray-200/50 border border-white p-6 md:p-8">
          <form onSubmit={handleLogin} className="space-y-4">
            {/* Error Message */}
            {error && (
              <div className="px-4 py-2 bg-red-50 border border-red-100 text-red-600 text-sm font-semibold rounded-2xl animate-in fade-in slide-in-from-top-2 duration-300 flex items-center">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-2 bg-gray-50/50 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-12 py-2 bg-gray-50/50 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 transition-all mb-2"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-end">
              <Link
                ...
                className="text-sm text-primary-600 font-medium italic hover:underline transition-colors duration-300"
              >
                Forgot Password?
              </Link>
            </div>
