            ...
            <section className="relative overflow-hidden bg-linear-to-br from-primary-600 via-primary-700 to-primary-900 text-white">
                ...
                <div className="relative container mx-auto px-4 py-20 md:py-28 mb-30">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-6 py-2 rounded-full mb-2 mt-6">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mt-12 mb-12">
                    {quickContacts.map((contact, index) => (
                        ...
                        >
                            ...
                            {/* CONTENT */}
                            <h3 className="text-base font-semibold text-gray-900 mb-1">{contact.title}</h3>
                            <p className="text-sm text-gray-500 mb-3">{contact.description}</p>
                            <p className="text-primary-700 font-semibold text-sm">{contact.link}</p>
                            <p className="text-xs text-gray-400 mt-1">{contact.linkText}</p>
                        </div>
                    ))}
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center">
                            <button className="px-6 py-3 bg-white text-primary-600 font-semibold rounded-full border-2 border-primary-600 hover:bg-primary-600 hover:text-white transition-all duration-300 shadow-md hover:shadow-xl">
                                View FAQ
                            </button>
                            <button className="px-6 py-3 bg-primary-600 text-white font-semibold rounded-full hover:bg-primary-700 transition-all duration-300 shadow-md hover:shadow-xl">
                                Download Brochure
                            </button>
                            <button className="px-6 py-3 bg-white text-gray-700 font-semibold rounded-full border-2 border-gray-300 hover:border-gray-400 transition-all duration-300 shadow-md hover:shadow-lg">
                                Export Guide
                            </button>
                        </div>
                    </div>
