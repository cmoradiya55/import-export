...
const AboutComponent = () => {
    ...
    return (
        <div className="bg-[#faf8f5] text-[#2d2d2d] overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section className="relative flex items-center justify-center bg-primary-950 text-white px-5 py-16">
                            ...
                            {storyItems.map((item, idx) => (
                                ...
                                >
                                    <div className="absolute -top-10 -right-10 text-6xl opacity-10 group-hover:opacity-20 transition">
                                        <img src={item.image} alt={item.title} className="w-70 h-70 object-contain mx-auto" />
                                    </div>
            ...
            <section className="py-16 bg-linear-to-br from-primary-600 to-primary-300 text-white text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    ...
                    <AnimateOnScroll animation="animate__fadeInUp" delay={`delay-3000ms`} className="animate__slow-1s">
                        <p className="text-lg mb-6 opacity-95">Partner with us for premium export foods that meet the highest international standards</p>
                    </AnimateOnScroll>
                    <AnimateOnScroll animation="animate__zoomIn" delay={`delay-3000ms`} className="animate__slow-1s">
                        <a href="#" className="inline-block px-8 py-2 bg-white text-primary-800 font-semibold text-lg rounded-full shadow-lg hover:-translate-y-1 hover:bg-[#faf8f5] transition-all">
                            Get In Touch
                        </a>
                    </AnimateOnScroll>
                </div>
