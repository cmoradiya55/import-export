...
const BlogDetailsComponents = ({ blogId }: { blogId: string }) => {
  ...
  const relatedBlogs = AllBlogData.filter(
    (b) => b.category === blog?.category && b.id !== blogId,
  ).slice(0, 3);
            ...
            >
              <div className="relative mb-12 overflow-hidden rounded-2xl bg-linear-to-br from-primary-50 to-primary-100/50 border-l-4 border-primary-600 shadow-lg">
                ...
                <div className="relative p-4">
                  <svg
                    className="w-8 h-8 text-primary-700 mb-2"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                {blog.content.split("\n").map((paragraph, index) => {
                  if (paragraph.startsWith("# ")) {
                    return (
                      <h1
                        key={index}
                        className="text-2xl font-bold text-black mt-8 mb-2"
                      >
              ...
              <div className="bg-primary-50 border border-primary-200 rounded-2xl p-4 mb-8 shadow-sm">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {blog.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-white text-gray-700 text-sm font-medium rounded-full border border-primary-600 hover:bg-primary-600/10 hover:text-primary-950 hover:border-primary-300 transition-all duration-300 cursor-pointer shadow-sm shadow-primary-50 hover:shadow-md"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-primary-600 to-primary-700 p-6 mb-8 shadow-xl">
                ...
                <div className="relative">
                  ...
                  <p className="text-primary-100 mb-6">
                    Help others discover this valuable export industry insight
                  </p>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {[
                      ...
                      <div
                        key={share.label}
                        className="text-center p-2.5 bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-shadow"
                      >
                        <Link
                          rel="stylesheet"
                          href={share.link}
                ...
                <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-primary-600 via-primary-700 to-primary-800 shadow-2xl p-6 text-white">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-primary-100 mb-5 text-sm">
                      Get weekly export insights, compliance updates, and market
                      trends.
                    </p>
                    <form className="space-y-3">
                      ...
                      <button
                        type="submit"
                        className="w-full px-4 py-3 bg-white text-primary-600 font-bold rounded-xl hover:bg-primary-50 transition-all duration-300 shadow-lg hover:text-primary-950 hover:shadow-xl hover:scale-105"
                      >
                        Subscribe Free
                      </button>
                    </form>
          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              ...
              <p className="text-lg text-primary-100 mb-6 max-w-xl mx-auto">
                Join hundreds of successful exporters who trust us for expert
                guidance on international food trade
              </p>
            </AnimateOnScroll>
            <AnimateOnScroll
              animation="animate__fadeInUp"
