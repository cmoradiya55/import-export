              ...
              >
                ...
                <div className="w-10 h-10 flex items-center justify-center bg-primary-100 rounded-lg mb-4 group-hover:bg-primary-600 transition-colors duration-300">
                  {React.createElement(contact.icon, {
                    className:
                      "w-5 h-5 text-primary-700 group-hover:text-white transition-colors duration-300",
                  })}
                </div>
                {/* CONTENT */}
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-gray-600 max-w-xl mx-auto">
                Fill out the form below and our export specialists will get back
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Trusted by exporters across 50+ countries
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Certified export consultants and specialists
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
              ...
              >
                <div className="bg-linear-to-br from-primary-50 to-primary-100 rounded-2xl p-8 border border-primary-200">
                  ...
                  <p className="text-sm text-gray-600 mt-4 bg-white/50 backdrop-blur-sm rounded-lg p-3">
                    ...
                    existing shipments and urgent matters
                  </p>
                </div>
              </AnimateOnScroll>
            </div>
