...
const slides: Slide[] = [
  {
    ...
    description:
      "From farm to international markets - delivering the finest organic spices with certifications and quality assurance.",
  ...
  },
  {
    ...
    description:
      "Experience the aromatic excellence of authentic Indian Basmati rice, trusted by importers across 50+ countries.",
  ...
  },
  {
    ...
    description:
      "From farm-fresh fruits to premium vegetables - maintaining quality through advanced cold chain logistics.",
  ...
  },
  {
    ...
    description:
      "Connecting Indian quality with global markets through sustainable practices and reliable partnerships.",
...
const Slider = () => {
  ...
  return (
    <div
      className="relative w-full h-[65vh] min-h-[500px] md:h-80 lg:h-150 overflow-hidden"
    ...
    >
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          {/* Content */}
          {index === currentSlide && (
            <div className="relative h-full flex items-center z-20 text-center lg:text-left">
              <div className="container mx-auto px-6 sm:px-8 lg:px-8 flex justify-center lg:justify-start">
                <div className="max-w-3xl">
                  ...
                  <p
                    ...
                    className="text-sm sm:text-base md:text-xl text-gray-200 mb-6 md:mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed animate__animated animate__fadeInLeft"
                  >
                    {slide.description}
                  </p>
                  ...
                  <div
                    ...
                    className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate__animated animate__fadeInUp animate__delay-1s"
                  >
                    <a
                      href={slide.ctaLink}
                      className="sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-primary-600 text-white font-bold rounded-full hover:bg-primary-700 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 group"
                    >
                      <span>{slide.cta}</span>
                    ...
                    <a
                      href="/contact"
                      className="sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-white/20 backdrop-blur-md text-white font-bold rounded-full border-2 border-white hover:bg-white hover:text-primary-600 transition-all duration-300"
                    >
