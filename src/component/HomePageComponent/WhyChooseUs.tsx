  ...
  const reasons = [
    {
      ...
      icon: "foodSafetyIcon",
      description:
        "All our products comply with international food safety and quality standards.",
    },
    {
      title: "Innovative Packaging",
      icon: "innovativePackagingIcon",
      description:
        "We offers eco-friendly packaging solutions for fresher, sustainable products.",
    },
    {
      title: "Export-Ready Packaging",
      icon: "exportReadyIcon",
      description:
        "We offer flexible customization in quality, packaging, and labeling.",
    },
    {
      title: "Reliable Global Logistics",
      icon: "globalLogisticsIcon",
      description:
        "Our strong global supplier and logistics network ensures reliable sourcing.",
    },
  ];
  ...
  return (
    <div className="px-3 sm:px-4 md:px-6 lg:px-8 xl:px-24">
      ...
      <AnimateOnScroll
        ...
        className="animate__slow-2s"
      >
        <div className="grid md:grid-cols-4 gap-12 sm:gap-6 mt-20">
